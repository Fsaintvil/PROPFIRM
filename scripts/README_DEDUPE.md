...
Note opérationnelle
-------------------
Avant d'ajouter ou d'exécuter des scripts modifiant massivement le dépôt
(ex: suppression, déplacement, réécriture), vérifiez `OPERATIONAL_RULES.md`
pour les exigences d'approbation et de traçabilité des actions. Toute action
automatisée importante doit être documentée dans un PR qui référence la
conversation opérationnelle correspondante.
