...
if not mt5.initialize():
    ...
    # Query history orders in a larger window (last 30 days)
...
json_path = os.path.join(OUT_DIR, f'orders_audit_30d_{ts}.json')
csv_path = os.path.join(OUT_DIR, f'orders_audit_30d_{ts}.csv')
