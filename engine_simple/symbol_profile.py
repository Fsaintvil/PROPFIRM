"""Profil institutionnel des 27 symboles actifs — connaissance approfondie pour le trading
...
Symboles actifs (1er Juillet 2026): 27 symboles — FOREX_MAJORS, FOREX_CROSSES,
CRYPTO, INDICES, EUROPE_INDICES, COMMODITIES.
...
# ── Profils institutionnels des 27 actifs ──
# 1er Juillet 2026: 27 symboles actifs
...
PROFILES: dict[str, SymbolInstitutionalProfile] = {
    ...
    "EURJPY": SymbolInstitutionalProfile(
        symbol="EURJPY",
        nickname="Euro-Yen",
        description="EUR/JPY — forex cross, volatilité moyenne, sessions asiatiques + london",
        avg_atr_pips=50.0,
        ...
        pip_factor=100.0,
        best_sessions=["asian", "london", "london_ny_overlap"],
        avoid_sessions=[],
        peak_hours_utc=[(1, 5), (8, 12), (13, 17)],
        adx_trend_threshold=22.0,
        rsi_overbought=70.0,
        rsi_oversold=30.0,
        bb_std_dev=2.0,
    ...
    "GBPJPY": SymbolInstitutionalProfile(
        symbol="GBPJPY",
        nickname="Sterling-Yen",
        description="GBP/JPY — forex cross, haute volatilité, surnommé 'the Beast'",
        avg_atr_pips=65.0,
    ...
    "EURGBP": SymbolInstitutionalProfile(
        symbol="EURGBP",
        nickname="Euro-Sterling",
        description="EUR/GBP — forex cross, faible volatilité, trading de range",
        avg_atr_pips=20.0,
        atr_percentile_high=35.0,
    ...
    "AUDJPY": SymbolInstitutionalProfile(
        symbol="AUDJPY",
        nickname="Aussie-Yen",
        description="AUD/JPY — forex cross, carry trade, sessions asiatiques",
        avg_atr_pips=40.0,
        atr_percentile_high=65.0,
    ...
    "GER40.cash": SymbolInstitutionalProfile(
        symbol="GER40.cash",
        nickname="DAX40",
        description="GER 40 Index — DAX allemand, blue chips, sessions européennes",
        avg_atr_pips=120.0,
        atr_percentile_high=200.0,
        atr_percentile_low=60.0,
        typical_spread_pts=25.0,
        spread_warning_pts=60.0,
        pip_factor=1.0,
        best_sessions=["london", "london_ny_overlap"],
        avoid_sessions=["asian"],
        peak_hours_utc=[(8, 12), (13, 17)],
    ...
    "UK100.cash": SymbolInstitutionalProfile(
        symbol="UK100.cash",
        nickname="FTSE100",
        description="UK 100 Index — FTSE britannique, valeurs défensives",
        avg_atr_pips=80.0,
        atr_percentile_high=130.0,
        atr_percentile_low=40.0,
        typical_spread_pts=25.0,
        spread_warning_pts=50.0,
        pip_factor=1.0,
        best_sessions=["london", "london_ny_overlap"],
    ...
    "ETHUSD": SymbolInstitutionalProfile(
        symbol="ETHUSD",
        nickname="Ethereum",
        description="ETH/USD — crypto #2, smart contracts, volatilité extrême",
        avg_atr_pips=60.0,
        atr_percentile_high=120.0,
        atr_percentile_low=25.0,
        typical_spread_pts=100.0,
        spread_warning_pts=250.0,
        pip_factor=1.0,
        best_sessions=["all"],
        avoid_sessions=[],
        peak_hours_utc=[(0, 23)],
    ...
    "SOLUSD": SymbolInstitutionalProfile(
        symbol="SOLUSD",
        nickname="Solana",
        description="SOL/USD — crypto haute performance, forte volatilité",
        avg_atr_pips=4.0,
        atr_percentile_high=8.0,
        atr_percentile_low=2.0,
    ...
    "BNBUSD": SymbolInstitutionalProfile(
        ...
        description="BNB/USD — Binance coin, volatilité moyenne pour une crypto",
        avg_atr_pips=15.0,
        atr_percentile_high=30.0,
        atr_percentile_low=8.0,
        typical_spread_pts=60.0,
    ...
    "US30.cash": SymbolInstitutionalProfile(
        symbol="US30.cash",
        nickname="Dow Jones",
        description="US 30 Index — Dow Jones Industrial Average, 30 blue chips US",
        avg_atr_pips=250.0,
        atr_percentile_high=400.0,
        atr_percentile_low=120.0,
        typical_spread_pts=25.0,
        spread_warning_pts=60.0,
        pip_factor=1.0,
        best_sessions=["ny_morning", "london_ny_overlap"],
        avoid_sessions=["asian", "asia_london_overlap"],
        peak_hours_utc=[(14, 17), (15, 16)],
        adx_trend_threshold=22.0,
        rsi_overbought=72.0,
        rsi_oversold=28.0,
        bb_std_dev=2.0,
    ...
    "US100.cash": SymbolInstitutionalProfile(
        symbol="US100.cash",
        nickname="Nasdaq",
        description="US 100 Index — Nasdaq 100, technologiques, forte volatilité",
        avg_atr_pips=200.0,
        atr_percentile_high=350.0,
        atr_percentile_low=100.0,
        typical_spread_pts=30.0,
        spread_warning_pts=70.0,
        pip_factor=1.0,
        best_sessions=["ny_morning", "london_ny_overlap"],
        avoid_sessions=["asian", "asia_london_overlap"],
        peak_hours_utc=[(14, 17), (15, 16)],
    ...
    "XAGUSD": SymbolInstitutionalProfile(
        symbol="XAGUSD",
        nickname="Silver",
        description="XAG/USD — Argent, volatilité > or, industriel + monétaire",
        avg_atr_pips=0.30,
        atr_percentile_high=0.50,
        atr_percentile_low=0.15,
        typical_spread_pts=50.0,
        spread_warning_pts=120.0,
        pip_factor=1.0,
        ...
        gap_risk=False,
        base_weight=0.9,
        spread_cost_factor=1.5,
        monthly_strength={},
    ),
    "USOIL.cash": SymbolInstitutionalProfile(
        symbol="USOIL.cash",
        nickname="WTI Oil",
        description="USOIL — West Texas Intermediate crude, benchmark pétrolier US",
        avg_atr_pips=0.70,
        atr_percentile_high=1.30,
        atr_percentile_low=0.35,
        typical_spread_pts=30.0,
        spread_warning_pts=80.0,
        pip_factor=1.0,
        best_sessions=["london", "london_ny_overlap", "ny_morning"],
        avoid_sessions=["asian"],
        peak_hours_utc=[(8, 12), (13, 17)],
        adx_trend_threshold=22.0,
        rsi_overbought=72.0,
    ...
    "UKOIL.cash": SymbolInstitutionalProfile(
        symbol="UKOIL.cash",
        nickname="Brent Oil",
        description="UKOIL — Brent crude, benchmark pétrolier international",
        avg_atr_pips=0.80,
        atr_percentile_high=1.50,
        atr_percentile_low=0.40,
        typical_spread_pts=30.0,
        spread_warning_pts=80.0,
        pip_factor=1.0,
        best_sessions=["london", "london_ny_overlap", "ny_morning"],
    ...
    "JP225.cash": SymbolInstitutionalProfile(
        symbol="JP225.cash",
        nickname="Nikkei225",
        description="JP 225 Index — Nikkei 225, indices japonais, sessions asiatiques",
        avg_atr_pips=500.0,
        atr_percentile_high=800.0,
        atr_percentile_low=250.0,
        typical_spread_pts=35.0,
        spread_warning_pts=80.0,
        pip_factor=1.0,
        best_sessions=["asian", "asian_london_overlap"],
        avoid_sessions=["ny_morning"],
        peak_hours_utc=[(0, 6), (8, 10)],
        adx_trend_threshold=22.0,
        rsi_overbought=72.0,
        rsi_oversold=28.0,
        bb_std_dev=2.0,
    ...
    "NZDUSD": SymbolInstitutionalProfile(
        symbol="NZDUSD",
        nickname="Kiwi",
        description="NZD/USD — paire forex mineure, sensible aux matières premières",
        avg_atr_pips=28.0,
        atr_percentile_high=45.0,
        atr_percentile_low=14.0,
        typical_spread_pts=10.0,
        spread_warning_pts=28.0,
        pip_factor=10000.0,
        best_sessions=["asian", "london_ny_overlap"],
        avoid_sessions=[],
        peak_hours_utc=[(1, 5), (13, 17)],
    ...
    "USDCHF": SymbolInstitutionalProfile(
        symbol="USDCHF",
        nickname="Swissie",
        description="USD/CHF — paire forex majeure, valeur refuge, SNB intervention risk",
        avg_atr_pips=25.0,
        atr_percentile_high=40.0,
        atr_percentile_low=12.0,
        typical_spread_pts=8.0,
    ...
    "NATGAS.cash": SymbolInstitutionalProfile(
        symbol="NATGAS.cash",
        nickname="Natural Gas",
        description="NATGAS — gaz naturel, volatilité extrême, news-driven",
        avg_atr_pips=0.10,
        atr_percentile_high=0.20,
        atr_percentile_low=0.05,
        typical_spread_pts=40.0,
        spread_warning_pts=100.0,
        pip_factor=1.0,
        best_sessions=["ny_morning", "london_ny_overlap"],
        avoid_sessions=["asian"],
        peak_hours_utc=[(13, 17), (14, 16)],
...
CORRELATION_GROUPS: dict[str, list[str]] = {
    ...
    "COMMODITIES": ["USOIL.cash", "UKOIL.cash", "NATGAS.cash"],
}
...
# Synchronisé avec portfolio_controller.py (1er Juillet 2026 — 27 symboles)
